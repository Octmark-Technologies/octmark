...
import SolutionMockup from "@/components/graphics/dash/SolutionMockup";
import { SOLUTION_PAGES, getSolutionPage } from "@/data/solutions";
...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: { title: page.metaTitle, description: page.metaDescription, url: `/solutions/${page.slug}`, type: "website" },
...
export default async function SolutionPage({
  ...
  const faqJsonLd = {
    ...
    about: { "@type": "Organization", name: "Octmark", url: baseUrl },
  };
      ...
      <main id="main" className="flex-1">
        ...
        >
          ...
          <div className="relative z-10 mx-auto max-w-[1280px] px-6 md:px-10 lg:px-20 pt-[150px] pb-24 grid grid-cols-1 lg:grid-cols-[6fr_5fr] gap-14 lg:gap-16 items-center">
            <Reveal>
              <Link href="/solutions" className="inline-flex items-center gap-1.5 text-[13px] text-[#8A96A8] hover:text-[#EEF1F7] font-sans mb-6 transition-colors">
                <ArrowRight size={13} className="rotate-180" /> Solutions
              </Link>
              ...
              <div className="flex flex-wrap items-center gap-4">
                ...
                <Link href="/demo" className="text-[14px] text-[#8A96A8] hover:text-[#EEF1F7] hover:underline font-sans transition-colors">
                  Book a demo →
                </Link>
              </div>
            </Reveal>
            ...
            <Reveal delay={0.15}>
              <Parallax distance={22}>
                <SolutionMockup mockup={page.mockup} />
              </Parallax>
            </Reveal>
          </div>
        </section>
        ...
        <section className="bg-white py-20 lg:py-24">
          <div className="mx-auto max-w-[1280px] px-6 md:px-10 lg:px-20 grid grid-cols-1 lg:grid-cols-[5fr_7fr] gap-12 lg:gap-16">
            <Reveal>
              ...
              <h2 className="font-display text-[30px] lg:text-[38px] text-[#3E3E3E] tracking-[-0.5px] leading-[1.18] mt-1">
                Built around the outcome you need
              </h2>
            </Reveal>
